...
export default function WhatsAppButton({ message }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-black/30 transition-all hover:bg-[#20BD5A] hover:shadow-xl active:scale-95"
    >
      {/* WhatsApp SVG icon */}
      <svg
        width="20"
